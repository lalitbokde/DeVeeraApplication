...
using System.Linq;
using System.Text;
using CRM.Core.Domain.GoogleTranslate.Misc;
using CRM.Core.Domain.GoogleTranslate.Objects.Error;
using CRM.Core.Domain.GoogleTranslate.Objects.LanguageDetection;
using CRM.Core.Domain.GoogleTranslate.Objects.SupportedLanguages;
using CRM.Core.Domain.GoogleTranslate.Objects.Translation;
using RestSharp;
using RestSharp.Serialization.Json;

namespace CRM.Core.Domain.GoogleTranslate.GoogleTranslate
{
    public class GoogleTranslate
    {
        ...
        public List<Translation> Translate(LanguageEnum sourceLanguage, LanguageEnum destinationLanaguage, params string[] text)
        {
            ...
            //Optional
            if (sourceLanguage != LanguageEnum.Automatic)
        ...
        public List<TranslationLanaguage> GetSupportedLanguages(LanguageEnum targetLanguage = LanguageEnum.Unknown)
        {
            //https://www.googleapis.com/language/translate/v2/languages?key=key&target=zh-TW
            RestRequest request = CreateRequest("languages");

            //Optional
            if (targetLanguage != LanguageEnum.Unknown)

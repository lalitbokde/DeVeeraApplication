...
using System.Linq;
using System.Text;
using DeVeeraApp.GoogleTranslateNet.Misc;
using DeVeeraApp.GoogleTranslateNet.Objects.Error;
using DeVeeraApp.GoogleTranslateNet.Objects.LanguageDetection;
using DeVeeraApp.GoogleTranslateNet.Objects.SupportedLanguages;
using DeVeeraApp.GoogleTranslateNet.Objects.Translation;
using RestSharp;
using RestSharp.Serialization.Json;

namespace DeVeeraApp.GoogleTranslateNet
{
    public class GoogleTranslate
    {
        ...
        public List<Translation> Translate(GoogleLanguage sourceLanguage, GoogleLanguage destinationLanaguage, params string[] text)
        {
            ...
            //Optional
            if (sourceLanguage != GoogleLanguage.Automatic)
        ...
        public List<TranslationLanaguage> GetSupportedLanguages(GoogleLanguage targetLanguage = GoogleLanguage.Unknown)
        {
            //https://www.googleapis.com/language/translate/v2/languages?key=key&target=zh-TW
            RestRequest request = CreateRequest("languages");

            //Optional
            if (targetLanguage != GoogleLanguage.Unknown)

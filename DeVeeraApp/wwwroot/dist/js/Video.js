...
var table = new Tabulator("#tabulatorVideo",
    {
        ...
        columns: [
           ...
           //{ title: "New", field: "IsNew", sorter: "boolean", width: 120 },
            { title: "Play", field: "actions", hozAlign: " ", width: 190, headerSort: false, formatter: function (e, t) { return `<a target="_blank" href="/Admin/Video/Play/${e.getData().Id}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></a></div>` }, },
        
            { title: "Spanish Play", field: "actions", hozAlign: " ", width: 190, headerSort: false, formatter: function (e, t) { return`<a target="_blank" href="/Admin/Video/SpanishPlay/${e.getData().Id}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=""bi bi-play""><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></a ></div >` }, },

...
var table = new Tabulator("#tabulator1",
    {
        columns: [
            ...
            { title: "Quote", field: "Title", sorter: "string", width: 300 },
            { title: "Author", field: "Author", sorter: "string", width: 180 },
            { title: "Level", field: "Level", sorter: "string", width: 150 },
            { title: "Dashboard Quote", field: "IsDashboardQuote", sorter: "boolean", width: 180 },
            { title: "Random Quote", field: "IsRandom", sorter: "boolean", width: 160 },
            { title: "Edit", field: "", hozAlign: "center", width: 100, headerSort: false, formatter: function (e, t) { return `<div class="flex lg:justify-center items-center">\n  <a href="/DashboardQuote/Edit/${e.getData().Id}" >\n <i data-feather="edit" class="text-theme-10"></i> \n</a>\n</div>   ` }, },
            { title: "Delete", field: "", hozAlign: "center", width: 120, headerSort: false, formatter: function (e, t) { return `<div class="flex lg:justify-center items-center">\n  <a onclick="ShowDeleteConfirmation('PostDeleteDashboardQuote(${e.getData().Id})')"" >\n <i data-feather="trash-2" class="text-theme-24"></i> \n</a>\n</div>   ` }, },],

...
var table = new Tabulator("#tabulator1",
    {
        ...
        columns: [
            ...
            { title: "Random Quote", field: "IsRandom", sorter: "boolean", width: 120, formatter: function (e, t) { return `<input class="checkbox-custom" type="checkbox" ${e.getValue() == true ? "checked" : ""}>` }, },

...
var table = new Tabulator("#tabulator1",
    {     
        ...
        pagination: "local",
        paginationSize: val,
        //paginationSizeSelector: [10, 20, 30, 40 , true],
        columns: [
            {
...
//  //  $("#tabulator1").tabulator("setPageSize", $(this).val());
//alert("eeee");
...
//$("#tabulator1").tabulator("setData", tabledata);

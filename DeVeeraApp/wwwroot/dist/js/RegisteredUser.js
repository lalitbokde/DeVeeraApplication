...
var table = new Tabulator("#tabulatorReg",
    {
        ...
        columns: [
            ...
            {
                title: "", field: "ImageUrl", headerSort: false, sorter: "string", width: 70, formatter: function (e, t) {return `<div class= "intro-x w-10 h-10 image-fit"><img alt="Tinker Tailwind HTML Admin Template" class="rounded-full" src="${e.getData().ImageUrl == null ? "/assets/img/avatar/NoImg.png" : e.getData().ImageUrl}"></div>`},},
            

            {
                title: "User Name", field: "Email", headerSort: true, sorter: "string", width: 170, formatter: function (e, t) {
                    return `${e.getData().Email}`
                },
            },

    ...
    public class ModuleController : BaseController
    {
        ...
        public IActionResult Index(int id, int srno, int levelSrno)
        {
            ...
            if (moduleData.VideoId != null)
            {
                ...
                //for youtube
                //var youtubeVideoUrl = _videoMasterService.GetVideoById((int)moduleData.VideoId);
                //var spanishYoutubeVideoUrl = _videoMasterService.GetVideoById((int)moduleData.VideoId);
                ////
                ...
                videoRecord.SpanishVideoUrl = videoUrl;
